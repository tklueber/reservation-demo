...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'P1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Watson'), '2017-01-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'W7'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Wagner'), '2017-01-01');
